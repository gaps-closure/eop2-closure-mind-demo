...
#pragma clang attribute push (__attribute__((annotate("XDLINKAGE_GET_FRAME"))), apply_to = any(function,type_alias,record,enum,variable(unless(is_parameter)),field))
...
#pragma clang attribute push (__attribute__((annotate("XDLINKAGE_GET_METADATA"))), apply_to = any(function,type_alias,record,enum,variable(unless(is_parameter)),field))
...
#pragma clang attribute push (__attribute__((annotate("XDLINKAGE_SEND_CAMCMD"))), apply_to = any(function,type_alias,record,enum,variable(unless(is_parameter)),field))
...
#pragma clang attribute push (__attribute__((annotate("XDLINKAGE_RUN_VIDEOPROC"))), apply_to = any(function,type_alias,record,enum,variable(unless(is_parameter)),field))
